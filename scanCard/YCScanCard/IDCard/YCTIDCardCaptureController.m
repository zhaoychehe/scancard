...
#import "YCTIDCardView.h"

@interface YCTIDCardCaptureController ()<AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureMetadataOutputObjectsDelegate>
...
@implementation YCTIDCardCaptureController
...
- (void)viewDidLoad {
    ...
    YCTIDCardView *FBYIDCard = [[YCTIDCardView alloc] initWithFrame:self.view.frame];
...
- (void)IDCardRecognit:(CVImageBufferRef)imageBuffer {
    ...
    if (CVPixelBufferLockBaseAddress(imageBuffer, 0) == kCVReturnSuccess) {
        ...
        if (ret <= 0) {
            ...
            YCCardIDInfo *iDInfo = [[YCCardIDInfo alloc] init];
            ...
            if (iDInfo) {// 读取到身份证信息，实例化出IDInfo对象后，截取身份证的有效区域，获取到图像
                ...
                CGRect effectRect = [YCCardRectManager getEffectImageRect:CGSizeMake(width, height)];
                ...
                YCIDCardDetailController *IDInfoVC = [[YCIDCardDetailController alloc] init];
